...
public class FavouriteColour {
    ...
    public static void main(String[] args) {
        ...
        // we disable the cache to demonstrate all the "steps" involved in the transformation - shouldn't use in prod
        ...
        KStream<String, String> usersAndColours = textLines
                ...
                // 4 - filter undesired colours (could be a data sanitization step
        ...
        KTable<String, Long> favouriteColours = usersAndColoursTable
                // 5 - group by colour within the KTable
                .groupBy((user, colour) -> new KeyValue<>(colour, colour))
                .count(Materialized.<String, Long, KeyValueStore<Bytes, byte[]>>as("CountsByColours")
                        .withKeySerde(stringSerde)
                        .withValueSerde(longSerde));

        // 6 - output the results to a Kafka Topic - don't forget the serializers
