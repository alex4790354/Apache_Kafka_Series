...
import ru.job4j.kafka.model.Issue;
import ru.job4j.kafka.model.PullRequest;
import ru.job4j.kafka.model.User;
import ru.job4j.kafka.utils.DateUtils;
...
import java.util.*;
import static ru.job4j.kafka.GitHubSchemas.*;
